...
/**
 * 
 * @ClassName: DubboConsumerAutoConfiguration
                ...
                try {
                    for (Field field : objClz.getDeclaredFields()) {
                        ...
                        if (dubboConsumer != null) {
                            ...
                            ReferenceBean<?> consumerBean = DubboConsumerAutoConfiguration.this.getConsumerBean(type,
                                    dubboConsumer);
                            ...
                            Object dubboReference = DubboConsumerAutoConfiguration.DUBBO_REFERENCES_MAP
                                    .get(classIdBean);
                            if (dubboReference == null) {
                                synchronized (this) {
                                    // double check
                                    dubboReference = DubboConsumerAutoConfiguration.DUBBO_REFERENCES_MAP
                                            .get(classIdBean);
                                    if (dubboReference == null) {
                                        ...
                                        if (registry == null) {
                                            consumerBean
                                                    .setRegistry(DubboConsumerAutoConfiguration.this.registryConfig);
                                        }
                                        consumerBean
                                                .setApplication(DubboConsumerAutoConfiguration.this.applicationConfig);
